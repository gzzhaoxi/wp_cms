...
EOF;
        ...
        */
        ...
        foreach($menus as $item){
            ...
            //
            //$arr_menu_list[]['lable'] = yii::t('menu', $item->name);
            //$arr_menu_list['url'] = array($item->url);
            $arr_menu_list[] = array(
                'label' => yii::t('menu', $item->name),
                'url' => array($item->url),
                'icon' => $item->icon,
                'options' => array('icon' => $item->icon),
                'items' => self::_getBackendSubMenu($menus, $item->id, '2')
            );
...
EOF;
        ...
        */
        ...
        foreach ($menus as $sub_item) {
            if ($sub_item->parent_id != $cur_id) {
                continue;
            }
            $arr_sub_list[] = array(
                'label' => yii::t('menu', $sub_item->name),
                'url' => array($sub_item->url),
                'icon' => $sub_item->icon,
                'options' => array('icon' => $sub_item->icon),
